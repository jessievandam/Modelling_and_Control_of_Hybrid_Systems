...
% Cost function to minimize
modelb1.obj = [W1.W1b1 S1.S1b1 S2.S2b1];
...
% Constraints
modelb1.A = sparse([zeros(size(F1.F1b1,1),size(W1.W1b1,2)) F1.F1b1 -F3.F3b1; ...
                    -eye(size(W2.W2b1,1)) -W2.W2b1 zeros(size(W2.W2b1,1),1); ...
                    -eye(size(W2.W2b1,1)) W2.W2b1 zeros(size(W2.W2b1,1),1)]);
...
% Cost function to minimize
modeld.obj = [W1.W1d S1.S1d S2.S2d];
...
% Constraints
modeld.A = sparse([zeros(size(F1.F1d,1),size(W1.W1d,2)) F1.F1d -F3.F3d; ...
                    -eye(size(W2.W2d,1)) -W2.W2d zeros(size(W2.W2d,1),1); ...
                    -eye(size(W2.W2d,1)) W2.W2d zeros(size(W2.W2d,1),1)]);
modeld.rhs = [F2.F2d; zeros(size(W2.W2d,1),1); zeros(size(W2.W2d,1),1)];
